...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    {
        title: 'Create',
        href: '/administration/departments/create',
    },
];

export default function Create({ regions, directorates }: Props) {
    ...
    const onSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        form.post('/administration/departments', {
            onSuccess: () => {
                toast.success('Department created successfully!');
            },
            onError: () => {
                toast.error('Failed to create department. Please check the form.');
            },
        });
    };
