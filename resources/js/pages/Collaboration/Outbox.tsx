...
import { Send, CheckCircle, XCircle, Eye, ArrowLeft, Clock } from 'lucide-react';
            ...
            <div className="flex h-full flex-1 flex-col gap-6 overflow-x-auto rounded-xl p-6 bg-transparent text-[#231F20] dark:text-white transition-colors">
                ...
                {requests.length === 0 && (
                    <div className="text-center py-12">
                        ...
                        <h3 className="text-lg font-semibold text-gray-600 dark:text-gray-400 mb-2">No sent requests</h3>
