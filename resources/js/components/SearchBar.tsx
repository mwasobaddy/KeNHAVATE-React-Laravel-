    ...
    return (
        <div className="flex items-center space-x-2">
            <input
                ...
                className="w-full rounded-lg border border-[#9B9EA4]/30 px-3 py-2 text-sm bg-white/80 dark:bg-[#231F20]/80 text-[#231F20] dark:text-[#F8EBD5]"
            />

            {local.length > 0 ? (
                <button aria-label="Clear search" onClick={clear} className="inline-flex items-center justify-center h-9 w-9 rounded-md bg-[#FFF200] text-[#231F20] hover:bg-[#F2E600] transition">
